...
title :: Page
title = writeTitle "Haskellの概略: ワークショップ" "10. 演習課題5" :| []
...
new1 = pageTitle "プロジェクトの作成" :| [
	text "実際には出来上がったディレクトリを参照してほしい",
	text "以下に、その出来上がったディレクトリの作成方法を示す",
	text "Stackのプロジェクトを新規に作成する",
	itext 4 "% stack new calc-quiz",
	text "実際には、ディレクトリcalc-quiz/を用意してあるので",
	itext 4 "そこに移動",
