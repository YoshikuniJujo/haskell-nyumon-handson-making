...
title :: Page
title = writeTitle "Haskell入門" "6. IOモナド" :| []
...
do4 = pageTitle "do記法" :| [
	...
	itext 4 "% vim samples/do.hs",
	itext 4 "io1 :: IO ()",
	itext 4 "io1 = do",
	itext 4 "        putStrLn \"hello\"",
	itext 4 "        s <- getLine",
	itext 4 "        putStrLn s",
	text "IOモナドの型は、次のIOにわたす値がなければ",
	itext 4 "IO ()",
...
if2 :: Page
if2 = pageTitle "分岐" :| [
	itext (- 4) "% vim samples/currentTime.hs",
...
if3 = pageTitle "分岐" :| [
	...
	text "試してみよう",
	itext 4 "> :load samples/currentTime.hs",
	itext 4 "> currentTime",
	itext 4 "現在時刻を取得します",
	itext 4 "ファイルに保存しますか?(Y/N)",
	itext 4 "(nを入力)n",
	itext 4 "2018-11-21 04:34:15.538628867 UTC"
	]

iteration1 :: Page
iteration1 = pageTitle "反復" :| [
	text "反復、つまり「くりかえし」は再帰で書くことができる",
	itext 4 "% vim samples/sum.hs",
...
main2 = pageTitle "独立して実行できるプログラム" :| [
	...
	itext 1 "% stack ghc -- samples/sum.hs -o sum",
	itext 1 "% ./sum",
	itext 1 "3",
	itext 1 "24",
	itext 1 "11",
