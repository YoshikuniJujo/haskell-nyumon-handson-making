...
title :: Page
title = writeTitle "Haskell入門" "4. 代数的データ型" :| []
...
expression2 = pageTitle "値構築演算子" :| [
	text "値構築演算子を定義してみる",
	itext 4 "% vim samples/expression.hs",
	itext 4 "data Expr",
...
expression3 = pageTitle "値構築演算子" :| [
	text "試してみる",
	itext 4 "> :load samples/expression.hs",
	itext 4 "> 123 :+ 456",
	itext 4 "123 :+ 456",
	itext 4 "> 111 :* 33",
	itext 4  "111 :* 33"
